...
public class ClienteImplementacionServicio implements ClienteServicio {
    ...
    @Override
    public Integer insertarCliente(String nombre, String apellido, String telefono, String correo, LocalDate fecha_nacimiento, String direccion) {
        return clienteRepositorio.insertarCliente(nombre, apellido, telefono, correo, fecha_nacimiento, direccion);
    }
